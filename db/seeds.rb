...
micronesia = Country.create!(name: 'Federated States of Micronesia', continent: 'Oceania', capital: 'Palikir', currency: 'United States Dollar (USD)')
...
# Country: Türkiye
turkey = Country.create!(name: 'Türkiye', continent: 'Asia', capital: 'Ankara', currency: 'Turkish Lira (TRY)')
